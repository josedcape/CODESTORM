    ...
    try {
      ...
      if (result.files && result.files.length > 0) {
        ...
        const filesMessage: Message = {
          ...
          content: `✅ **Sitio web moderno generado exitosamente**\n\n📁 **Archivos creados:**\n${cleanFiles.map(file => `• \`${file.path}\``).join('\n')}\n\n🎨 **Vista previa integrada activada** - Tu sitio web se renderiza completamente con todas las funcionalidades:\n• ✨ Animaciones CSS3 en tiempo real\n• 🖱️ Interactividad JavaScript completa\n• 📱 Responsive design testeable\n• 🎯 Efectos hover y transiciones\n\n💡 **Próximos pasos:**\n• Usa los controles de vista previa para probar diferentes dispositivos\n• Interactúa con la página para probar funcionalidades\n• Solicita modificaciones específicas si necesitas cambios`,
          sender: 'assistant',
          timestamp: Date.now(),
          type: 'suggestion',
        ...
        const previewMessage: Message = {
          ...
          content: '🎨 **Vista previa integrada lista** - Tu sitio web se muestra con renderizado completo, incluyendo todas las animaciones, efectos y funcionalidades JavaScript. Puedes interactuar con la página y probar diferentes tamaños de pantalla usando los controles integrados.',
          sender: 'assistant',
          timestamp: Date.now(),
          type: 'preview'
        };
                  ...
                  {message.type === 'preview' && (
                    <div className="mt-2 flex space-x-2">
                      <button
                        ...
                        className="px-2 py-1 bg-codestorm-accent/40 hover:bg-codestorm-accent/60 text-white text-xs rounded flex items-center"
                      >
          ...
          <div className="hidden md:flex md:w-1/2 border-l border-codestorm-blue/30 flex-col">
            <div className="p-3 bg-codestorm-blue/10 border-b border-codestorm-blue/30 flex justify-between items-center">
              <h3 className="text-sm font-medium text-white flex items-center">
                <Eye className="h-4 w-4 mr-2 text-codestorm-accent" />
