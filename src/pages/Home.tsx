...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-codestorm-darker">
      {/* Startup Sequence: Video → Intro → Menu */}
      {showStartupSequence && (
        <StartupSequence
          onComplete={() => {
      ...
      <main className="container flex-1 px-4 py-8 mx-auto">
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            <h2 className={`${isMobile ? 'text-2xl' : 'text-3xl'} font-bold text-white mb-4 flex items-center justify-center gap-3`}>
              <span className="text-4xl">🎬</span>
              Descubre CODESTORM en Acción
            </h2>
            <p className="text-gray-300 max-w-2xl mx-auto text-lg">
              Mira cómo nuestra plataforma de IA revoluciona el desarrollo de software
              con agentes especializados trabajando en tiempo real.
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="relative p-4 bg-gradient-to-br from-codestorm-dark to-codestorm-darker rounded-2xl border-2 border-codestorm-accent/30 shadow-2xl shadow-codestorm-accent/20">
              {/* Decorative corners */}
              <div className="absolute top-2 left-2 w-4 h-4 border-t-2 border-l-2 border-codestorm-accent rounded-tl-lg"></div>
              <div className="absolute top-2 right-2 w-4 h-4 border-t-2 border-r-2 border-codestorm-accent rounded-tr-lg"></div>
              <div className="absolute bottom-2 left-2 w-4 h-4 border-b-2 border-l-2 border-codestorm-accent rounded-bl-lg"></div>
              <div className="absolute bottom-2 right-2 w-4 h-4 border-b-2 border-r-2 border-codestorm-accent rounded-br-lg"></div>

              {/* Video Title Bar */}
              <div className="flex items-center justify-between mb-4 p-3 bg-codestorm-darker/50 rounded-lg border border-codestorm-blue/20">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white font-medium">codestorm.mp4</span>
                </div>
              ...
              {/* Video Description */}
              <div className="mt-4 p-3 bg-codestorm-darker/30 rounded-lg border border-codestorm-blue/10">
                <p className="text-gray-300 text-sm text-center">
                  <span className="text-codestorm-accent font-semibold">Video oficial de CODESTORM</span> -
                  Demostración completa de las capacidades de la plataforma
                </p>
              </div>
            </div>
          </div>
