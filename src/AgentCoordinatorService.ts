...
export class AgentCoordinatorService {
  ...
  /**
   * Inicia el proceso de generación de un sitio web MODERNO y ATRACTIVO
   */
  public async generateWebsite(description: string): Promise<{
    ...
    try {
      console.log('🚀 Iniciando generación de sitio web MODERNO con coordinación mejorada');
      ...
      // 2. NUEVO: Usar WebAIEnhanceAgent para coordinación mejorada
      console.log('🎨 Iniciando generación con WebAIEnhanceAgent...');
      ...
      try {
        ...
        console.log('✅ Sitio web moderno generado exitosamente');
        console.log('📊 Resumen de mejoras:', enhancedResult.enhancementSummary);
        ...
        mainTask.result = {
          success: true,
          message: 'Sitio web moderno generado con éxito',
        ...
        console.warn('⚠️ Error con WebAIEnhanceAgent, usando método tradicional:', enhanceError);

        // Fallback al método original si falla el nuevo agente
  ...
  /**
   * Método tradicional de generación como fallback
   */
