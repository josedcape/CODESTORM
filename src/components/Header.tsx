...
import { Terminal, Code, Settings, Eye, MessageSquare, Hammer, ArrowLeft, Menu, X, AlertCircle, Globe, Home, Bot } from 'lucide-react';
      ...
      <div className="container mx-auto flex justify-between items-center relative z-10">
        ...
        {!isMobile && (
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            {isConstructorPage || isCodeCorrectorPage || isWebAIPage || isAgentPage ? (
              <Link
                to="/menu"
              ...
              <>
                ...
                {showConstructorButton && (
                  <>
                    ...
                    <Link
                      to="/agent"
                      className="flex items-center space-x-1 bg-purple-500/20 hover:bg-purple-500/30 rounded-md px-3 py-1.5 transition-all duration-300 text-purple-400 hover:shadow-md hover:shadow-purple-500/20 transform hover:-translate-y-0.5 active:translate-y-0 active:scale-95"
                      title="Ir al Sistema AGENT"
                    >
                      <Bot className="h-4 w-4 transition-transform duration-300 hover:scale-110" />
                      <span className={isTablet ? 'hidden' : ''}>AGENT</span>
                    </Link>
                  </>
                )}
              </>
