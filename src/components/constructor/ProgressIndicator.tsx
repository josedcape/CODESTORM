...
const ProgressIndicator: React.FC<ProgressIndicatorProps> = ({
  ...
  const sortedItems = Object.values(progress.itemsProgress).sort((a, b) => {
    ...
    <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-4 max-w-4xl mx-auto">
      ...
      <div className="mb-4">
        <div className="flex justify-between text-sm text-gray-600 dark:text-gray-300 mb-1">
          <span>Fase actual: {progress.currentPhase}</span>
        ...
        <div className="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-1">
          <span>Elementos completados: {progress.completedItems} de {progress.totalItems}</span>
