...
import { voiceRecognitionService, VoiceRecognitionEvent, VoiceRecognitionResult } from '../../services/VoiceRecognitionService';
...
const VoiceInputButton: React.FC<VoiceInputButtonProps> = ({
  ...
  const handleClearTranscript = () => {
    setTranscript('');
    setError(null);
    voiceRecognitionService.clearTranscript();
  };
