...
// Componente simple que redirige directamente al menú
const MainAppWithIntro: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-codestorm-darker flex items-center justify-center">
      <div className="text-white text-xl">Cargando...</div>
    </div>
  );
};

// Componente para mostrar intro manualmente
const IntroPage: React.FC = () => {
  const navigate = useNavigate();

  const handleIntroComplete = () => {
    console.log('🎬 Intro completed, navigating to menu');
    navigate('/menu');
  };
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/legacy-menu" element={<MainAppWithIntro />} />
    </Routes>
  );
}
