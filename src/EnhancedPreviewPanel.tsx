...
const EnhancedPreviewPanel: React.FC<EnhancedPreviewPanelProps> = ({
  ...
  // Obtener archivos HTML disponibles con validación de seguridad
  const htmlFiles = files.filter(file =>
    file && file.path && typeof file.path === 'string' &&
    file.path.toLowerCase().endsWith('.html') && file.content
  );

  // Obtener archivos CSS disponibles con validación de seguridad
  const cssFiles = files.filter(file =>
    file && file.path && typeof file.path === 'string' &&
    file.path.toLowerCase().endsWith('.css') && file.content
  );

  // Obtener archivos JS disponibles con validación de seguridad
